...
| V5 浏览器验收 | broken image=0;overflowX=0;手机端单列;最终口吻无审稿话术;视觉自评>=80 | G6/G7 | checklist.md + eval-rubric.md |
...
| 视觉不舒服/空白大/图文乱/平庸/发糊 | V5 | G6+G7 | design-constraints.md + eval-rubric.md |
| 总结经验/踩坑/eval/持续变厚 | 规则维护 | G7 | gotchas.md |
...
references/
  ...
  design-constraints.md   <- 箱子反平庸清单(为什么 + 机器检测方式)
  eval-rubric.md          <- 视觉质量 100 分评分表,<80 回炉
  gotchas.md              <- 踩坑记录模板,发现丑点后追加
...
稳定优于性格 / 内容自洽优于演讲辅助 / 结构优于装饰 / 约束优于灵感 / 章节呼吸优于段落连贯 /
